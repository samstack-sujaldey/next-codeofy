        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center py-10 px-8">
          <ScrollReveal direction="down">
            <div className="text-center md:text-left">
              ...
              <div className="flex gap-4">
                ...
                <button className="border px-6 py-3 rounded-lg text-black bg-white transition-all duration-300 hover:-translate-y-1 active:translate-y-0 ">
                  View Our Work
                </button>
              </div>
            </div>
          ...
          <ScrollReveal direction="down" duration={0.8}>
            <div className="relative bg-blue-100 rounded-2xl flex items-center justify-center h-72">
              ...
              />
              <div className="absolute bottom-0  -translate-x-1/2  left-29 flex items-center gap-2 sm:gap-3 bg-white rounded-2xl h-12 sm:h-14 w-4/5 sm:w-2/4 p-2 sm:px-6 translate-y-1/2 shadow-md">
                <MdOutlineVerified
                  size={25}
                  className="bg-blue-700 text-blue-300 p-1 rounded-full sm:size-30px"
                />
